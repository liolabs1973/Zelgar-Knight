...
-- Version : 1.2 du 26-02-2023                                  --
--           Animations des personnages, des objets.            --
-- **************************************************************** --
--                                                              --
-- Bugs Corrigés :                                              --
-- *******************                                              --
...
function love.load()
   ...
   bonus              = love.graphics.newImage("assets/Images/bonus.png")
   ...
   collectSound       = love.audio.newSource("assets/Sounds/collect.mp3", "static")
